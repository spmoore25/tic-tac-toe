...
function Board() {
    ...
    this.checkForWinner = function() {
        ...
        const postions = this.positions;

        winningCombinations.forEach((winningCombo) => {
            const pos0InnerText = postions[winningCombo[0]].innerText;
            const pos1InnerText = postions[winningCombo[1]].innerText;
            const pos2InnerText = postions[winningCombo[2]].innerText;
